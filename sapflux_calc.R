...
dtqa <- dtCalc[dtCalc$velo <= 0.5,]

ggplot(dtqa[dtqa$sensor ==1,], aes(x=DD,y=velo))+ 
  geom_point()

ggplot(dtqa[dtqa$sensor ==2,], aes(x=DD,y=velo))+ 
  geom_point()

ggplot(dtqa[dtqa$sensor ==3,], aes(x=DD,y=velo))+ 
  geom_point()+
  geom_line()
ggplot(dtqa[dtqa$sensor ==4,], aes(x=DD,y=velo))+ 
  geom_point()+
  geom_line()
ggplot(dtqa[dtqa$sensor ==5,], aes(x=DD,y=velo))+ 
  geom_point()+
  geom_line()
ggplot(dtqa[dtqa$sensor ==6,], aes(x=DD,y=velo))+ 
  geom_point()+
  geom_line()
ggplot(dtqa[dtqa$sensor ==7,], aes(x=DD,y=velo))+ 
  geom_point()+
  geom_line()
ggplot(dtqa[dtqa$sensor ==8,], aes(x=DD,y=velo))+ 
  geom_point()+
  geom_line()
ggplot(dtqa[dtqa$sensor ==9,], aes(x=DD,y=velo))+ 
  geom_point()+
  geom_line()
ggplot(dtqa[dtqa$sensor ==10,], aes(x=DD,y=velo))+ 
  geom_point()+
  geom_line()
ggplot(dtqa[dtqa$sensor ==11,], aes(x=DD,y=velo))+ 
  geom_point()+
  geom_line()
ggplot(dtqa[dtqa$sensor ==12,], aes(x=DD,y=velo))+ 
  geom_point()+
  geom_line()
ggplot(dtqa[dtqa$sensor ==13,], aes(x=DD,y=velo))+ 
  geom_point()+
  geom_line()
ggplot(dtqa[dtqa$sensor ==14,], aes(x=DD,y=velo))+ 
  geom_point()+
  geom_line()
ggplot(dtqa[dtqa$sensor ==15,], aes(x=DD,y=velo))+ 
  geom_point()+
  geom_line()
ggplot(dtqa[dtqa$sensor ==16,], aes(x=DD,y=velo))+ 
  geom_point()+
  geom_line()